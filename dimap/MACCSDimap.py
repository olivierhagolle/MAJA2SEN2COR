...
class MACCSDimap(MACCSMasks):
    ...
    def ReadMACCSMetadata( cls
        ...
        d_dimapValue['product'] = o_docMACCS.getTagNodeValue(o_parent,'IDENT')
        ...
        # Geocoding 
        d_dimapValue['HORIZONTAL_CS_NAME'] = 'N/A'
        d_dimapValue['HORIZONTAL_CS_CODE'] = o_docMACCS.getNodeValue( o_docMACCS.getIndirectNode(o_rootMACCS,'PROJECTION') )
        
        # Geoposition
        o_ULX = o_docMACCS.getIndirectNodes( o_rootMACCS, 'ORIGIN_X' )
        o_ULY = o_docMACCS.getIndirectNodes( o_rootMACCS, 'ORIGIN_Y' )
        o_XDIM = o_docMACCS.getIndirectNodes( o_rootMACCS, 'PIXEL_SIZE_X' )
        o_YDIM = o_docMACCS.getIndirectNodes( o_rootMACCS, 'PIXEL_SIZE_Y' )
        o_NROWS = o_docMACCS.getIndirectNodes( o_rootMACCS, 'NB_ROWS' )
        o_NCOLS = o_docMACCS.getIndirectNodes( o_rootMACCS, 'NB_COLS' )
        s_ULX = []
        s_ULY = []
        s_XDIM = []
        s_YDIM = []
        ...
        o_Mean_Viewing_Angles = o_docMACCS.extractNode(o_docMACCS.getIndirectNode( o_rootMACCS, 'Mean_Viewing_Angles' ))
        o_Mean_Viewing_Angles.tagName = 'Mean_Viewing_Incidence_Angle'
        o_Azimuth = o_docMACCS.getIndirectNode(o_Mean_Viewing_Angles, 'Azimuth')
        o_Azimuth.tagName = 'AZIMUTH_ANGLE'
        o_Zenith = o_docMACCS.getIndirectNode(o_Mean_Viewing_Angles, 'Zenith')
        o_Zenith.tagName = 'ZENITH_ANGLE'
        
        # Mean_Sun_Angle
        o_Mean_Sun_Angle = o_docMACCS.extractNode(o_docMACCS.getIndirectNode( o_rootMACCS, 'Mean_Solar_Angles'))
        o_Mean_Sun_Angle.tagName = 'Mean_Sun_Angle'
        o_Azimuth = o_docMACCS.getIndirectNode(o_Mean_Sun_Angle, 'Azimuth')
        o_Azimuth.tagName = 'AZIMUTH_ANGLE'
        o_Zenith = o_docMACCS.getIndirectNode(o_Mean_Sun_Angle, 'Zenith')
        o_Zenith.tagName = 'ZENITH_ANGLE'
            
        logging.info('Read metadata from MACCS product finish without error : %s',_s_productPath)
        
        return d_dimapValue, o_Mean_Viewing_Angles, o_Mean_Sun_Angle
    ...
    def WriteSen2corMetadata( cls
        ...
        o_childMean_Viewing_Incidence_Angle_List = doc.createElement('Mean_Viewing_Incidence_Angle_List')
        o_childTile_Angles.appendChild(o_childMean_Viewing_Incidence_Angle_List)
        o_childMean_Viewing_Incidence_Angle_List.appendChild(_o_Mean_Viewing_Angles)
    ...
    def Convert( cls
        ...
        d_dimapValue, o_Mean_Viewing_Angles, o_Mean_Sun_Angle = cls.ReadMACCSMetadata(_s_productPath)
